...
yellow_taxis = pd.read_csv('../flash/NYCTaxiData/yellow_taxi/2018/yellow_tripdata_2018-02.csv')
...
yellow_taxis.to_csv('../flash/NYCTaxiData/yellow_taxi/2018/yellow_tripdata_2018-02-duration.csv')
